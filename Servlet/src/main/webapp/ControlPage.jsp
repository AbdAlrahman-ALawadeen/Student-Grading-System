...
<%
    ...
    Long ID = (Long) request.getAttribute("ID");  // Receive ID
%>
...
<div class="container">
    ...
    <form action="<%= type.equals("Admin") ? "handleAdminChoice.jsp" : (type.equals("Teacher") ? "handleTeacherChoice.jsp" : "handleStudentChoice.jsp") %>" method="post">
